...
def hz_debug(odom_msg):
    hz_debug_msg = odom_msg
    pub_hz_debug.publish(hz_debug_msg)
...
if __name__ == '__main__':
    ...
    rospy.Subscriber('/Odometry_imu', Odometry, hz_debug, queue_size=1)
    
    pub_hz_debug = rospy.Publisher('/hz_test', Odometry, queue_size=1)
    ...
    # 发布定位消息
    # rospy.Timer(rospy.Duration(1.0 / FREQ_PUB_LOCALIZATION), transform_fusion)
